...
<script src="${ctx}/assets/plugins/jqvmap/jqvmap/jquery.vmap.min.js" type="text/javascript"></script>
...
<script src="${ctx}/assets/plugins/gritter/js/jquery.gritter.min.js" type="text/javascript"></script>
